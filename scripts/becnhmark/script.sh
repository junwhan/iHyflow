...
do
	...
	m)	case "$OPTARG" in
            dtl)    valid_mode=true
                    dir="org.infinispan.iHyflow.core.dir.dtl2.TrackerDirectory"
                    context="org.infinispan.iHyflow.core.tm.dtl.Context"
                    cm="org.infinispan.iHyflow.core.cm.policy.Default"
                    bench="tm.$bench"
                    ;;
			dtl2)	valid_mode=true
				dir="org.infinispan.iHyflow.core.dir.dtl2.DTL2Directory"
				context="org.infinispan.iHyflow.core.tm.dtl2.Context"
				cm="org.infinispan.iHyflow.core.cm.policy.Default"
				bench="tm.$bench"
				;;	
			cf)	valid_mode=true
				dir="org.infinispan.iHyflow.core.dir.control.ControlFlowDirectory"				
				context="org.infinispan.iHyflow.core.tm.control.undoLog.Context"
				cm="org.infinispan.iHyflow.core.cm.policy.Karma"
				bench="tm.$bench"
				;;					
			log)	valid_mode=true
				dir="aleph.dir.cm.home.HomeDirectory"
				context="org.infinispan.iHyflow.core.tm.undoLog.Context"
				cm="org.infinispan.iHyflow.core.cm.policy.Timestamp"
				bench="tm.$bench"
				;;					
			dsm)	valid_mode=true
				dir="aleph.dir.home.HomeDirectory"
				context="org.infinispan.iHyflow.core.tm.empty.Context"
				cm="org.infinispan.iHyflow.core.cm.policy.Default"
				bench="dsm.$bench"
				;;
			rmi)	valid_mode=true
...
do
    ...
    then 
	echo "Starting [$i]"
	$PROG -Xmx512m -Djava.security.policy=./hyflow/no.policy -javaagent:../../../hyflow/hyflow.jar \
