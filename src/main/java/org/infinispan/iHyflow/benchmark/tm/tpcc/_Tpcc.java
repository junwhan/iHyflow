...
public class _Tpcc extends AbstractLoggableObject 
{
	...
	{
		try {
			locks__ADDRESS__ = AddressUtil.getAddress(_Tpcc.class
					.getDeclaredField("locks"));
			item__ADDRESS__ = AddressUtil.getAddress(_Tpcc.class
					.getDeclaredField("NUM_ITEMS"));
			id__ADDRESS__ = AddressUtil.getAddress(_Tpcc.class
					.getDeclaredField("id"));
			$HY$_proxy__ADDRESS__ = AddressUtil.getAddress(_Tpcc.class
					.getDeclaredField("$HY$_proxy"));
			$HY$_id__ADDRESS__ = AddressUtil.getAddress(_Tpcc.class
