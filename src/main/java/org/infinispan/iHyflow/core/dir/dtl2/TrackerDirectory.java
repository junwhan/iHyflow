package org.infinispan.iHyflow.core.dir.dtl2;
...
import org.infinispan.iHyflow.core.tm.dtl.Context;
import org.infinispan.iHyflow.core.tm.dtl.LocalClock;
import org.infinispan.iHyflow.core.tm.dtl.LockTable;
import org.infinispan.iHyflow.core.tm.dtl2.ReadSet;
...
public class TrackerDirectory extends DirectoryManager {
	...
	//	return local.get(key);
		//return null;
	//}
	public AbstractDistinguishable getLocalCache(Object key){
		AbstractDistinguishable object = HyFlow.getMyObject(key); 
		return object;
	}	
